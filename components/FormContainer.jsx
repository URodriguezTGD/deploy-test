...
export const FormContainer = () => {
    ...
    return (
        <div className={FormContainerStyle.formContainer}>
            <form id="contactForm" className={FormContainerStyle.form} autoComplete="off" onSubmit={handleSubmit(onSubmitForm)}>
                <div className={FormContainerStyle.row}>
                    ...
                    <span className={FormContainerStyle.error} >{errors?.fullName?.message}</span>
                </div>
                <div className={FormContainerStyle.row}>
                    <input type="text" 
                        id="email" 
                    ...
                    <span className={FormContainerStyle.error} >{errors?.email?.message}</span>
                </div>
                <div className={FormContainerStyle.row}>
                    <input type="text" 
                        id="asunto" 
                    ...
                    <span className={FormContainerStyle.error} >{errors?.asunto?.message}</span>
                </div>
                <div className={FormContainerStyle.row}>
                    <textarea id="message" 
                        name="message" 
                    ...
                    <span className={FormContainerStyle.error}>{errors?.message?.message}</span>
                </div>
                <div className={FormContainerStyle.row}>
