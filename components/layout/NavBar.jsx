            ...
            <nav>
                <div className={ menuClicked ? 'nav-wrapper': "nav-wrapper container" }>
                    ...
                    <ul className="left hide-on-med-and-down">
                        <li>
                            <a href={ locale === 'es' ? '/es' : '/en' }>{t.inicio}</a>
                        </li>
                        <li>
                            <a href={ locale === 'es' ? '/es/services' : '/en/services' }>{t.servicios}</a>
                        </li>
                    </ul>
                    <ul className="right hide-on-med-and-down">
                        <li>
                            <a href={ locale === 'es' ? '/es/blog' : '/en/blog' }>{t.blog}</a>
                        </li>
                        <li>
                            <a href={ locale === 'es' ? '/es/contact' : '/en/contact' }>{t.contacto}</a>
                        </li>
                        <li>
